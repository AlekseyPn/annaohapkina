<?php
 require_once "SendMailSmtpClass.php"; // подключаем класс
  ...
  $html .= '<tr>
		...
		<td style="padding: 10px;  font-size: 24px">'.$_POST["tel"]."</td>";
  $html .= '<tr>
		<td style="padding: 10px; font-size: 24px">Сообщение: </td>
		<td style="padding: 10px; font-size: 24px">'.$_POST["question"]."</td></table></html>";
  $mail_to = "nyura.ohapckina@yandex.ru";
   //$mail_to =  $_POST['email'];
  //mr.maxego@gmail.com
